...
/*
    public void drawNewGame(Graphics g){
        ...
        drawCenteredString("NEW GAME", getRealWidth(), getRealHeight(), g);
    }
 ...
 */
    public void drawEndGame(Graphics g, int points, String code) {
        ...
        drawCenteredString("Level code: "+ code, getRealWidth(), getRealHeight() * 2  - (Game.TILES_SIZE * 2) * Game.SCALE, g);
    }
